...
namespace kinectProject
{
    public partial class CurveDataViewer : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            float offsetX = curveData.OriginalOffsetX;
            float scaleX = curveData.OriginalScaleX;
            ...
            if (curveData.ManualZRef > 0)
            {
                ...
                using (Pen refPen = new Pen(Color.Red, 1) { DashStyle = DashStyle.Dash })
                {
            ...
            {
                using (Pen refPen = new Pen(Color.Orange, 1) { DashStyle = DashStyle.Dash })
                {
                    g.DrawLine(refPen, curveData.FixedDeepestXPixel, 0, curveData.FixedDeepestXPixel, ClientSize.Height);
                }
                g.DrawString($"Ref Line: {curveData.FixedDeepestXPixel:F0}", labelFont, Brushes.Orange,
                    curveData.FixedDeepestXPixel + 5, 30);
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.Load += new EventHandler(this.CurveDataViewer_Load);
